...
<?php 
    ...
    //$staffid =$_POST['staff_staffid'];
    
    
        $sql = "SELECT * FROM ticket";
        //$query = "UPDATE ticket SET  custname = '$custname', ticketcode='$ticketcode', helpdesc='$helpdesc', phone='$phone', email='$email', extension=$extension, tickdate='$tickdate', staff_staffid=$staffid WHERE custid = $custid";
        echo $sql;
													...
													<div class="forms-main_agileits">
															...
															<div class="graph-form agile_info_shadow">
															 <h3 class="w3_inner_tittle two">Basic Form </h3>
																	<div class="form-body">
                                                                    <form class="form-horizontal" name="login" method="post" action = "custprob.php"> 
